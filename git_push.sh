...
1#!/bin/bash
2set -e
3cd /home/team/shared
4

5echo "=== Setting up Git ==="
6git init
7git remote add origin https://github.com/ThaGuff/plex-automation.git
8git config user.email "deploy@plex.automation"
9git config user.name "PLEX Deploy"
10
...
14echo "=== Committing ==="
15git commit -m "PLEX Automation MVP - Full stack SaaS"
16

17echo "=== Pushing to GitHub ==="
18git push -u origin main 2>&1 || echo "Push failed - need auth. Use: git push -u origin main"
19
