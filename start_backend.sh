...
1#!/bin/bash
2set -e
3cd /home/team/shared/backend
4echo "=== Installing deps ==="
5pip3 install --break-system-packages fastapi uvicorn sqlalchemy "python-jose[cryptography]" bcrypt cryptography httpx 2>&1
6echo "=== Starting server ==="
7cd /home/team/shared/backend
8python3 -m uvicorn app.main:app --host 0.0.0.0 --port 8001 &
9sleep 3
10echo "=== Verifying ==="
11curl -s http://localhost:8001/health
12echo ""
13echo "=== DONE ==="
Agent:
AGENT-LEAD
